...
var OverlayRequestResponseInterceptor = (function () {
    ...
    OverlayRequestResponseInterceptor.prototype.intercept = function (req, next) {
        ...
        return next
            .handle(req)
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["delay"])(randomTime), // Simulate random Http call delays
        Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["tap"])(function (event) {
